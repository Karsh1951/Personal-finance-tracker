...
export const FinancialRecordForm = () => {
  ...
  const { user } = useUser();
//we write event to demonstrate the type of event taking place on the button(submit)
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();//it prevents the page from submitting when we refresh the page
